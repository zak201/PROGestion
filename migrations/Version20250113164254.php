 ...
 */
final class Version20250113164254 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE lot (id INT AUTO_INCREMENT NOT NULL, numero_lot VARCHAR(255) NOT NULL, statut VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE vehicule (id INT AUTO_INCREMENT NOT NULL, numero_chassis VARCHAR(255) NOT NULL, marque VARCHAR(255) DEFAULT NULL, couleur VARCHAR(255) DEFAULT NULL, statut VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
